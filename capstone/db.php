...
class MysqliDb
{
     ...
     * @param string $socket
     */
    public function __construct($host = null, $username = null, $password = null, $db2 = null, $port = null, $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
    ...
    public function tableExists($tables)
    {
        ...
        $db2 = isset($this->connectionsSettings[$this->defConnectionName]) ? $this->connectionsSettings[$this->defConnectionName]['db'] : null;
        $this->where('table_schema', $db2);
...
$db = new mysqli("127.0.0.1","","","jyhjyh777"); 
$db->set_charset("utf8");

// db 변수에 데이터베이스 연결한 객체를 넣음

$db2 = new MysqliDb ("127.0.0.1","","","jyhjyh777");
?>
